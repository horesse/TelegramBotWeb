...
namespace TelegramBot.ApiService.Infrastructure.Data.Migrations
{
    ...
    [Migration("20250518174800_Add link from bot to chats")]
    partial class Addlinkfrombottochats
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TelegramBot.ApiService.Domain.Entities.Bot", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("TelegramBot.ApiService.Domain.Entities.Chat", b =>
                {
                    b.HasOne("TelegramBot.ApiService.Domain.Entities.Bot", "Bot")
                        .WithMany("Chats")
                        .HasForeignKey("BotId")
